          ...
          <table className="w-full text-sm text-left min-w-[600px]">
            <thead className="bg-slate-50 dark:bg-slate-700/50 text-slate-500 dark:text-slate-400 capitalize">
              <tr>
                ...
                <th className="px-4 md:px-6 py-3 md:py-4 font-semibold">Email Account</th>
                <th className="px-4 md:px-6 py-3 md:py-4 font-semibold">Role</th>
                  ...
                  <tr key={u._id} className="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors">
                    <td className="px-4 md:px-6 py-3 md:py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-bold text-slate-800 dark:text-white truncate">{u.name}</span>
                      </div>
                    </td>
                    <td className="px-4 md:px-6 py-3 md:py-4 text-slate-600 dark:text-slate-400 truncate">{u.email}</td>
                    <td className="px-4 md:px-6 py-3 md:py-4">
                      <span className={`px-2 py-0.5 md:px-2.5 md:py-1 text-xs font-bold rounded-full whitespace-nowrap ${u.role === 'admin' ? 'bg-purple-100 text-purple-700' :

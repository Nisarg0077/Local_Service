      ...
      <div className="flex flex-col md:flex-row min-h-full">
        ...
        <aside className="w-full md:w-64 shrink-0 border-r border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-300 flex flex-col pt-4">
          <div className="p-6 border-b border-slate-100 dark:border-slate-700">
            <h3 className="font-heading font-bold text-slate-800 dark:text-white text-xl">⚡ Admin Panel</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">SmartLocal Management</p>
          </div>
          ...
          <div className="p-4 border-t border-slate-100 dark:border-slate-700 space-y-2">
            ...
            <button onClick={handleLogout} className="flex items-center gap-2 w-full px-4 py-2.5 text-red-500 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10 rounded-xl text-sm font-medium transition-colors">
